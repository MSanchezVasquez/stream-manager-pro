      ...
      >
        ...
        <div className="flex items-center justify-end gap-2 pt-3">
          <button
            ...
            onClick={onClose}
            className="px-4 py-2.5 rounded-xl text-xs font-bold text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-500/10 active:scale-95 transition-all uppercase tracking-wider"
          >
            CERRAR
          </button>
          <button
            ...
            className="px-4 py-2.5 rounded-xl text-xs font-bold text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-500/10 active:scale-95 transition-all uppercase tracking-wider flex items-center gap-2"
          >
            {isLoggingOut && <CircularSpinner size={14} className="text-blue-500" />}
            CERRAR SESIÓN
          </button>
        </div>
      </div>
